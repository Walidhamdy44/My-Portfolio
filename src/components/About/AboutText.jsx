const AboutText = () => {
  return (
    <div className="text">
      <h2>
        I’m Walid Hamdy. I live in El Minya City, where I design the future.
      </h2>
      <div>
        <p>I was born on August 13, 2002, in El Minya , Egypt.</p>
        <p>
          I attended elementary school, followed by preparatory school, and then
          completed secondary education. Afterward, I enrolled in the Faculty of
          Science.
        </p>
      </div>
      <div>
